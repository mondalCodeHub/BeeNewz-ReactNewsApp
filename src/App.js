  ...
  render() {
    return (
      <>
        <div>
          <Router>
            ...
            <Switch>
              ...
              <Route exact path="/general"> <News setProgress={this.setProgress} apiKey={this.apiKey} key="generalx" pageSize={this.pageSize} country="in" category="general" /> </Route>
        ...
        <div className="foot">
          <footer className=" footDesign"><a href="https://github.com/mondalCodeHub">&copy; mondalCodeHub </a></footer>
        </div>
      </>
    )
  }
